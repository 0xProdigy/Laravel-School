        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="pager">
            <div class="flex justify-between flex-1 sm:hidden">
                <span>
                    ...
                    @else
                        <li>
                            <button wire:click="previousPage('{{ $paginator->getPageName() }}')" wire:loading.attr="disabled" dusk="previousPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}.before" class="btn btn-success">
                                {!! __('pagination.previous') !!}
                            </button>
                        </li>
                    @endif
                ...
                <span>
                    @if ($paginator->hasMorePages())
                        <li>
                            <button wire:click="nextPage('{{ $paginator->getPageName() }}')" wire:loading.attr="disabled" dusk="nextPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}.before" class="btn btn-success">
                                {!! __('pagination.next') !!}
                            </button>
                        </li>
                    @else
